    ...
    <div class="headings">
            ...
            <div class='postBlock'>
                ...
                <div class='attachement-div'>
                    <input type="file" class='attachement-file' id="attachement0" name="attachement0" data-uploadsuccess="0" data-uploadfile="null" multiple />
                    <span class="user-attach-icon attachement-icon" data-content_title="Click to add an attachment Please note attachment must be an image or in a  PDF file format. zip & rar file can only be downloaded" style="width: 18%; margin-top: 4px;padding-left: 18px;">
                        Add attachement
    ...
    <?php if( $totalComments > 0 ){
        ...
        foreach ($comments as $commentId => $commentDetails) {
            ...
            ?>
                ...
                <div class="dd_coment_box "<?php echo $commentBoxClassColor; ?> style="width:98%;" <?php echo $spamCommentStyle; ?> >
                        ...
                        <div class="dd_coment" data-commentid="<?=$commentDetails['comment']->id;?>">
                            ...
                            <ul class="dd_coment_heading" style="overflow: visible;">
                                ...
                                if( isset($commentDetails['comment']->attachement) ){
                                    ...
                                    <li><a class="user-attach-icon tooltip attachement <?=$classNotAllowed;?>" <?=$dowloadAttachementLink;?> style="margin-right: 5px;"><span class="classic"><?=$originaleFileName;?></span></a></li>
                            ...
                            if( $commentDetails['comment']->is_spam == '1' ){
                                ...
                                <?php }
                                    ...
                                    if( $reportAsSpamAllow ){?>
                                        ...
                                        <a class="floatLeft reportAsSpam" data-commentid="<?=$commentDetails['comment']->id;?>" style="font-size:0.8em; margin-left:25px;"><em>Report as spam</em></a>
                            ...
                            <ul class="dd_social_list ">
                                ...
                                <li><a href="https://www.linkedin.com" class="tooltip linked"><span class="classic"></span></a></li>
                            </ul>
                            <div class='postBlock'>
                        ...
                        <?php
                            ...
                            foreach ($commentDetails['post_comment'] as $postsComments) {
                                ...
                                ?>
                                <div class="dd_coment_box <?php echo $postCommentBoxClassColor;?> hiddenPostComments" style="width:98%;" <?php echo $spamCommentStyle;?> >
                                    <div class="user_image">
                                    <?php
                                    ...
                                    <?php
                                        ...
                                        <?php
                                            ...
                                            if( $reportAsSpamAllow ){?>
                                                ...
                                                <a class="floatLeft reportAsSpam" data-commentid="<?=$postsComments['id'];?>" style="font-size:0.8em; margin-left:25px;"><em>Report as spam</em></a>
