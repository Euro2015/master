    ...
    <div class="right_content">
     ...
     <ul class="main_icons">
      ...
      <ul class="main_icons">
		...
		<a href="<?php echo $this->createUrl('/admin/department');?>" title="Business supermarket Department Emails">   

		<img  src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/department_emails.png" width="75px" height="75px" />     
 ...
 <li>
            <a href="<?php echo $this->createUrl('/admin/pages/pages');?>" title="Business supermarket update pages">
              <img  src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/listing.jpg" width="75px" height="75px" />
            </a>
        </li>		
      ...
      <ul class="main_icons">
        <li>
            <a href="<?php echo $this->createUrl('/admin/prize/prize');?>" title="<?php echo Yii::app()->params['company_name']; ?> prize draw module">
